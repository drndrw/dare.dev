...
export default function About(props: any) {
  ...
  return (
    <>
      ...
      <p>While contacting at Apple, I developed several tools to facilitate automation and project tracking for a team of 15 people. My early projects included a Python-based diffing tool for comparing language-specific text strings, as well as a Python-based image QA tool, used to validate designer-produced images
